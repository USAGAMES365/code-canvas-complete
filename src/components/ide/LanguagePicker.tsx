...
const templateVisuals: Record<LanguageTemplate, { icon: React.ReactNode; color: string }> = {
  ...
  video: { icon: <Video className="w-8 h-8" />, color: "from-purple-500 to-pink-500" },
};
          ...
          <div className="text-center py-8 space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground/70 mt-1">
                e.g. "I want to build a REST API" or "I'm a beginner learning to code"
              </p>
            </div>
          </div>
        )}
                  ...
                  {(() => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-xs font-medium text-primary">Use {lang?.name || templateId}</span>
            ...
            {attachments.map((att) => (
              ...
              >
                {att.type === "image" ? (
                  ...
                  <FileAudio className="w-2.5 h-2.5 text-primary" />
                ) : (
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="max-w-5xl w-full">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-foreground mb-3">Create a Canvas</h1>
